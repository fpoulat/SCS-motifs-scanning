...
(* d'éléments "Integer", avec des fonctionnalités        *) 
...
type
  ...
  TIntegerPtrList 
   = array[0..MaxIntegerListSize - 1] of Integer;
  
  TIntegerListSortCompare 
   = function (Item1, Item2: Integer): Integer;
  
  TIntegerDescriptor 
   = function (Index:Integer;Item : Integer) : string;
  ...
  protected
    ...
    function  FastFindUp(Value:Integer;
                  var Position:Integer):Integer;
    function  FastFindDown(Value:Integer;
                  var Position:Integer):Integer;
  ...
  public
    ...
    property  Items[Index: Integer]: Integer 
                  read Get 
                  write Put; default;
    property  SortType:TIntegerSortOption 
                  read FSortType 
                  write SetSortType;
  end;
...
function  TIntegerList.NormalAdd
