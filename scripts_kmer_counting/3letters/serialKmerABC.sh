...
indir=StrandUnAwareSites_files		        # directory of input gellyroll files
outdir=../StrandUnAwareSites_files_FastaFake	# directory to store results of sed transcoding
